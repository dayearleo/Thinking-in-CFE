...
```
总计:      18 项
├─ 已修:   18 项 (100%) ✅ ALL DONE
├─ Cleanup: 3 项 (✅ commit 8b98649)
├─ P0:      3 项 (✅ commit 9c7c4ac)
├─ P1:      5 项 (✅ commit 254aab4)
└─ P2:      3 项 (✅ commit 待落地 P2)
```

**完成状态**:✅ 全部 18 项已落地 · CFE 论文已通过 audit + revision 阶段 · 进入 RFC ready 状态。
...
### ✅ P1-2 · §99 year/published 精确化 (DONE · Belovs/Reichardt/Farhi-Goldstone-Gutmann/Childs-Cleve-Jordan-Yonge-Mallo/Wiesner 5 entries)
...
### ✅ P1-3 · §99 模糊 cite entry 精确化 (DONE · Barnum 2002/Gottesman 2003/Lord 2024/QIUP 2025/Filatov-Auzinsh 2024 + 加 L2 CQC 6 entries + 加 M Fomin 2013)
...
### ✅ P1-4 · §05.4 D3 加 constructor theory framing (Violaris 2025) (DONE)
...
### ✅ P1-5 · §00 摘要 + §05.3 加 N≤10 niche 限定 (DONE)
...
### ✅ P2-1 · Salih thousands MZI caveat (DONE · 已在 §11.2 CAVEAT 3 + §15.5 4 scenario 表 covered · §99 entry 完整 · §14/§17 不直接引 Salih · 无需额外)
...
### ✅ P2-2 · 12 simulator README 批量加 SOTA caveat (DONE · Python batch 12 README 一次性加同样 caveat 段)
...
### ✅ P2-3 · §03.10 限界 N ≤ 12-32 更新 (DONE · 改为 N=5-6 实测 + N=12-32 platform mode 区分)
