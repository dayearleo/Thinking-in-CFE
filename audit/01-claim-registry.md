...
## 进度统计 (最近一次更新:2026-06-20 sample batch 1)

```
Total:       230
UNVERIFIED:  225  (97.8%)
Audited:       5  ( 2.2%)
├─ CONFIRMED:   1   (AUD-E-003)
├─ PARTIAL:     2   (AUD-E-004, AUD-C15-001)
├─ GAP:         0
├─ REFUTED:     1   (AUD-E-014 · 重大 attribution 错误 · [Hance 2025] → [Franco-Camillini-Galvão 2026])
└─ NOVEL:       1   (AUD-C06-002)
```

最后审计:AUD-C15-001 · 下一个待审:推荐 AUD-C03-015 (跟 AUD-E-014 REFUTED 强耦合 · 必复审 N=12 photonic SOTA 数字)

### sample batch 1 关键发现 (落 04-audit-summary.md 详)

1. **REFUTED [Hance 2025]**:论文多处引 `[Hance 2025]` 实际是 `[Franco-Camillini-Galvão 2026]` (arxiv 2604.04691) · 必须全文 replace 并修 §99
2. **PARTIAL [Lin-Lin 2015]**:公式 $B_\delta(f) = O(Q(f)^2/\delta)$ 是对 Lin-Lin 原版 $B(f) = \Theta(Q(f)^2)$ 的 $\delta$ extension · 论文未明确说 · 必须修
3. **PARTIAL [PCC 命名]**:漏 [Noh 2009] CQC 子领域 17 年 prior-art · §02 必须加 + 考虑改 PCC 名
4. **NOVEL Subtractive Computation Paradigm**:命名 NOVEL · 但 §06.1 应加 "Subtraction-free complexity (Fomin 2013)" 第 5 类邻近 disambig
5. **CONFIRMED Mitchison-Jozsa 2001**:attribution 完全准
...
| ID | 来源 | claim 速述 | 优先级 | Status |
|---|---|---|---|---|
| AUD-E-001 | 多 | [Wheeler 1978] 延迟选择思想实验 | P1 | UNVERIFIED |
| AUD-E-002 | 多 | [Elitzur-Vaidman 1993] interaction-free measurement | P0 | UNVERIFIED |
...
| AUD-E-013 | §02 | [Filatov-Auzinsh 2024] multi-object IFM | P0 | UNVERIFIED |
...
| AUD-E-027 | §03 | [Farhi 2008] NAND-tree quantum walk algorithm | P0 | UNVERIFIED |
| AUD-E-028 | §03 | [Childs 2009] discrete NAND-tree algorithm | P0 | UNVERIFIED |
...
| AUD-E-044 | §01 | [Yang 2026] (跟我们工作时间最近的同领域工作 · 必查) | P0 | UNVERIFIED |
